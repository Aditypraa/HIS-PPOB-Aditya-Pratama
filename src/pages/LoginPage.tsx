...
function LoginPage() {
    ...
    const hasError = (field: string) => formError && formError.toLowerCase().includes(field);
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center p-8 sm:p-12 lg:p-16 order-2 md:order-1">
                <div className="max-w-md mx-auto w-full">
                    ...
                    <div className="flex items-center mb-6">
                        <img src="https://placehold.co/30x30/f87171/ffffff?text=S" alt="SIMS Logo" className="h-8 w-8 mr-2 rounded" />
                        <span className="text-xl font-bold text-gray-800">SIMS PPOB</span>
                    </div>
                    <h2 className="text-2xl font-semibold text-gray-800 mb-2">Masuk atau buat akun</h2>
            ...
            <div className="hidden md:flex w-1/2 items-center justify-center p-8 relative overflow-hidden bg-[#FFF8F4] order-1 md:order-2">
                <img
                    src="https://placehold.co/400x400/3b82f6/ffffff?text=Ilustrasi"
                    alt="Ilustrasi Login"
                    className="max-w-sm lg:max-w-md xl:max-w-lg object-contain z-10 rounded-lg"
                    onError={(e) => {
                        const target = e.target as HTMLImageElement;
                        target.src = 'https://placehold.co/400x400/cccccc/ffffff?text=Gagal+Muat';
                    }}
                />
