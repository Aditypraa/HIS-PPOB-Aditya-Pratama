  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleRegister}>
            ...
            <InputField
              ...
              error={formError && !firstName ? formError : null}
            />
            <InputField
              icon={User}
              type="text"
              ...
              error={formError && !lastName ? formError : null}
            />
            <InputField
              icon={Lock}
              type="password"
              ...
              error={
                formError.includes("password") || formError.includes("minimal")
                  ? formError
                  : null
              }
            />
            <InputField
              ...
              error={formError.includes("cocok") ? formError : null}
            />
            {/* Display local form error */}
            {formError &&
              !formError.includes("email") &&
              !formError.includes("password") &&
              !formError.includes("minimal") &&
              !formError.includes("cocok") &&
              !formError.includes("field") && (
      ...
      <div className="hidden md:flex w-1/2 items-center justify-center p-8 relative overflow-hidden bg-[#FFF8F4] order-1 md:order-2">
        ...
        <div className="absolute bottom-10 left-10 w-20 h-20 bg-purple-200 rounded-lg opacity-50 transform -rotate-12"></div>{" "}
        <div className="absolute top-1/2 left-10 w-8 h-8 bg-pink-200 rounded-full opacity-50"></div>
      </div>
    </div>
  );
}
